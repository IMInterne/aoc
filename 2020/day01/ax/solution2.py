...
if __name__ == '__main__':
    with open("data") as f:
        ...
        for number in numbers:
            ...
            remaining_sum = 2020 - number
            solvable, solution = _find_sum(remaining_sum, all_numbers)

            if solvable:
                first, second = solution
                product = number * first * second
                print(f"{product}")
                break
